    ...
    with open(f'labirint_{cur_date}.csv', 'w') as file:
        ...
        headers = {
            ...
            'user-agent': 'Mozilla/5.0(Windows NT 10.0;Win64;x64) AppleWebKit/537.36(KHTML, likeGecko'
                          ') Chrome/100.0.4896.60Safari/537.36Edg/100.0.1185.29'
        }
